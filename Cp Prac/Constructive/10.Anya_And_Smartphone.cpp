...
void solve()
{
    ...
    while (m--)
    {
        ll click;
        cin >> click;
        ll whre = bsearch(arr, click);
        ll arrpos1 = whre;
        whre = arr[whre].second;
        ans += 1 + whre / k;
        if (whre > 0)
        {
            ll elemap = umap[whre - 1];
            ll whre2 = bsearch(arr, elemap);
            ll arrpos2 = whre2;
            whre2 = arr[whre2].second;
            ll temp = arr[arrpos2].second;
            arr[arrpos2].second = arr[arrpos1].second;
            arr[arrpos1].second = temp;
            umap[whre] = arr[arrpos2].first;
            umap[whre2] = arr[arrpos1].first;
        }
        // cout << "\n";
        // for (auto x : umap)
        // {
