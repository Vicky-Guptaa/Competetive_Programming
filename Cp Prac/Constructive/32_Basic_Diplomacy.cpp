...
bool mycomp(pair<vll, int> &a, pair<vll, int> &b)
{
    return a.first.size() < b.first.size();
}

bool mycomp1(pll &a, pll &b)
{
...
void solve()
{
    ...
    sort(vr(result), mycomp1);
    py;
    fl(i, 0, result.size()) cout << result[i].first << " ";
