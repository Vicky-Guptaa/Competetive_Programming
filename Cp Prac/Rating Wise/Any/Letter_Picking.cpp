...
ll helper(int strt, int end, string &s, vector<vector<int>> &dp)
{
    if (strt == end - 1)
    {
        if (s[strt] == s[end])
    ...
    ll m1 = helper(strt + 1, end - 1, s, dp);
    ll m2 = helper(strt, end - 2, s, dp);
    ll m3 = helper(strt + 2, end, s, dp);
    if ((m1 == 1 && m2 == 1) || (m1 == 1 && m3 == 1))
    {
        return dp[strt][end] = 1;
    }
    else if ((m1 == 0 && m2 == 1) && s[end] < s[strt])
        return dp[strt][end] = 1;
    else if ((m1 == 0 && m3 == 1) && s[strt] < s[end])
        return dp[strt][end] = 1;
    else if ((m1 == 1 && m2 == 0) && s[end] < s[end - 1])
        return dp[strt][end] = 1;
    else if ((m1 == 1 && m3 == 0) && s[strt] < s[strt + 1])
        return dp[strt][end] = 1;
    else if ((m1 == 0 && m2 == 0) && s[end] < max(s[end - 1], s[strt]))
        return dp[strt][end] = 1;
    else if ((m1 == 0 && m3 == 0) && s[strt] < max(s[end], s[strt + 1]))
        return dp[strt][end] = 1;
    else
    {
...
void solve()
{
    ...
    ll ans = helper(0, (int)s.size() - 1, s, dp);
    if (ans == 0)
    {
        cout << "Draw\n";
    }
