...
vector<vector<char>> crr = {{'R', 'G', 'B'}, {'G', 'B', 'R'}, {'B', 'R', 'G'}};

int helper(string str, int n, int m, int indx)
{
    int ans = 1e9;
    fl(i, 0, n - m + 1)
    {
...
void solve()
{
    ...
    string str;
    cin >> str;
    ll ans = min(helper(str, n, m, 0), min(helper(str, n, m, 1), helper(str, n, m, 2)));
    cout << ans << "\n";
}
/*
