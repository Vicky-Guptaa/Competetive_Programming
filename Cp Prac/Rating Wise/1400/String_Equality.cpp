...
void solve()
{
    ...
    while (!bfreq.empty())
    {
        if (bfreq.begin()->first >= freq.begin()->first)
        {
            if (bfreq.begin()->second > freq.begin()->second)
            {
                bfreq.begin()->second -= freq.begin()->second;
                freq.erase(freq.begin());
            }
            else if (bfreq.begin()->second < freq.begin()->second)
            {
                freq.begin()->second -= bfreq.begin()->second;
                bfreq.erase(bfreq.begin());
            }
            else
            {
                bfreq.erase(bfreq.begin());
