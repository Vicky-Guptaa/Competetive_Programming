...
bool isValid1(vpll &brr, vll eachW, int mid, int n, int m)
{
    ll wcnt = 0;
    fl(i, 0, n)
    {
...
bool isValid2(vpll &brr, vll eachW, int mid, int n, int m)
{
    int indx = 0;
    fl(i, 0, n)
    {
...
void solve()
{
    ...
    {
        int mid = (low + high) / 2;
        if (isValid1(brr, eachW, mid, n, m) || isValid2(brr, eachW, mid, n, m))
        {
            rank = mid;
            high = mid - 1;
        }
