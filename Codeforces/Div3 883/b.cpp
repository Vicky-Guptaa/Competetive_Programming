...
bool checkH(vector<string> &srr, char ch)
{
    fl(i, 0, 3)
    {
        int cnt = 0;
...
bool checkV(vector<string> &srr, char ch)
{
    fl(i, 0, 3)
    {
        int cnt = 0;
...
bool checkD(vector<string> &srr, char ch)
{
    if (srr[0][0] == ch && srr[1][1] == ch && srr[2][2] == ch)
        return true;
    if (srr[0][2] == ch && srr[1][1] == ch && srr[2][0] == ch)
        return true;
    return false;
}
...
void solve()
{
    vector<string> srr(3);
    cin >> srr;
    bool isX = checkH(srr, 'X') || checkD(srr, 'X') || checkV(srr, 'X');
    bool isO = checkH(srr, 'O') || checkD(srr, 'O') || checkV(srr, 'O');
    bool isP = checkH(srr, '+') || checkD(srr, '+') || checkV(srr, '+');
