...
// Sorting
bool sortpa(const pair<ll, ll> &a, const pair<ll, ll> &b) { return (a.second < b.second); }
bool sortpd(const pair<ll, ll> &a, const pair<ll, ll> &b) { return (a.second > b.second); }
