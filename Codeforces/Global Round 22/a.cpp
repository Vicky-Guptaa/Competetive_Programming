...
void solve()
{
    ...
    sort(vr(o), greater<ll>());
    sort(vr(z), greater<ll>());
    if (o.size() > z.size())
    {
        ll score = 0;
        fl(i, 0, z.size()) score += 2 * z[i] + 2 * o[i];
        fl(i, z.size(), o.size()) score += o[i];
        cout << score << "\n";
    }
    else if (o.size() < z.size())
    {
        ll score = 0;
        fl(i, 0, o.size()) score += 2 * z[i] + 2 * o[i];
        fl(i, o.size(), z.size()) score += z[i];
        cout << score << "\n";
    }
    else
    {
