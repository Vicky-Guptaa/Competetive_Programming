...
void solve()
{
    ...
    bool isRight = 0, isZero = 0;
    if (arr[0].first - arr[1].first == 0 || arr[0].first - arr[2].first == 0 || arr[1].first - arr[2].first == 0)
    {
        isRight = true;
    }
    if (arr[0].second - arr[1].second == 0 || arr[0].second - arr[2].second == 0 || arr[1].second - arr[2].second == 0)
    {
        isZero = true;
    }
    if (isRight && isZero)
