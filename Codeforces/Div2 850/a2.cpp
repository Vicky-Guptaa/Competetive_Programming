...
void solve()
{
    ...
    n -= 1;
    bool isAlice = false;
    ll whiteAlice = 1, whiteBob = 0;
    bool isStartBlack = true;
    while (n >= iter)
    {
        if (isAlice)
        {
    ...
    ll blackAlice = alice - whiteAlice, blackBob = bob - whiteBob;
    cout << whiteAlice << " " << blackAlice << " " << whiteBob << " " << blackBob << "\n";
}
/*
