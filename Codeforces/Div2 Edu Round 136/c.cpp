...
vll fact(70, 0), alex(61, 0), boris(61, 0);
...
void solve1()
{
    ...
    {
        alex[i] = boris[i - 2] + nCr(i - 1, (i / 2) - 1);
        alex[i] = ((alex[i] % mod) + mod) % mod;
        boris[i] = (nCr(i, (i / 2)) - alex[i] - 1) % mod;
        boris[i] = ((boris[i] % mod) + mod) % mod;
    }
}
...
void solve()
{
    ll n;
    cin >> n;
    ll ans1 = alex[n], ans2 = boris[n], ans3 = 1;
    cout << ans1 << " " << ans2 << " " << ans3 << "\n";
}
/*
